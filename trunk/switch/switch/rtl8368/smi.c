...
int MDC_MDIO_WRITE(rtk_uint32 preamble_len, rtk_uint32 phy_id, rtk_uint32 register_id, rtk_uint32 data){
	return 0;
}

int MDC_MDIO_READ(rtk_uint32 preamble_len, rtk_uint32 phy_id, rtk_uint32 register_id, rtk_uint32 *pdata){
	return 0;
}
#endif
