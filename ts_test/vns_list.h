...
//dont use typeof , because it is not in ANSI C
#define typeof(x)  aaa
#define BUG_ON(x) do{}while(0)
#define prefetch(x) (void)1
#define smp_wmb()    do{}while(0) 
#define my_offsetof(TYPE, MEMBER) ((size_t) &((TYPE *)0)->MEMBER)

#if 1
static inline char*__container_addr(void*p) {
	return (char*)p;
}
#define container_of(ptr, type, member) \
(type*)(__container_addr(ptr) - my_offsetof(type,member))
#else
#define container_of(ptr, type, member) ({                \
